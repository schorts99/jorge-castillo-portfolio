export const PROJECTS = [
  ...
  },
  {
    ...
    description:
      'A wrapper implementing fallback caching mechanisms between LocalStorage, SessionStorage, and memory stores under a unified provider pattern.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'An automated shell script utility built to bootstrap high-productivity development environments, dotfiles, and system utilities seamlessly.',
    highlights: [
